...
{
	cout << "\n Matrix  A: " << endl; //Виведення підказки для введення матриці а
	...
	cout << endl;
	cout << "Column B: " << endl; //Виведення підказки для введення стовпчика b
	for (int i = 0; i < n; i++) //Зовнішній цикл по рядку
	{
...
{
	cout << "\n Matrix A: " << endl; //Виведення інформації про виведення матриці a
	for (int i = 0; i < n; i++) //Зовнішній цикл по рядку
	{
		for (int j = 0; j < n; j++) //Внутрішній цикл по стовпцю
		{
	...
	cout << endl;
	cout << "Column B: " << endl; //Виведення стовпчика b
	for (int i = 0; i < n; i++) //Зовнішній цикл по рядку
	{
...
{
	cout << "\n Matrix A, Witch changes " << z + 1 << " columns in matrix B: " << endl; //Виведення інформації про змінення в матриці
	for (int i = 0; i < n; i++) //Зовнішній цикл по рядку
	{
		for (int j = 0; j < n; j++) //Внутрішній цикл по стовпцю
		{
...
/// <summary><c>main1</c> є головною функцією.
...
int main1()
{
	...
	int n = 3, i = 0, j = 0, z = 0, det = 0, y = 0, x = 0,l; //Дійсні змінні

	cout << "\n MatrixSize: "; //Виведення підказки для введення розміру квадратної матриці
	...
	else
	{
		...
		for (int z = 0; z < n; z++) //Цикл по знаходженню визначників зміненої матриці та х
		{
			...
			cout << "\n   det[" << z + 1 << "], which was founded with " << z + 1 << "columns in matrix: " << y << endl; /*Виведення значень визначників, що
